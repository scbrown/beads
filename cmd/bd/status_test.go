...
func TestStatusCommand(t *testing.T) {
	...
	if stats.StatusBlockedIssues != 1 {
		t.Errorf("Expected 1 status-blocked issue, got %d", stats.StatusBlockedIssues)
	}
	if stats.BlockedIssues != 0 {
		t.Errorf("Expected 0 dependency-blocked issues, got %d", stats.BlockedIssues)
	}
